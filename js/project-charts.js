...
(function () {
  ...
  function safeEmbed(selector, specOrUrl) {
    ...
    if (typeof vegaEmbed !== "function") {
      console.error("vegaEmbed not available");
    ...
    vegaEmbed(selector, specOrUrl, opts).catch((err) => {
      ...
      el.innerHTML = "<p>Chart failed to load. Check console.</p>";
    });
  }
  ...
  const vis1 = {
    ...
    layer: [
      ...
      {
        mark: { type: "area", opacity: 0.15, color: "#64748b", interpolate: "monotone" },
        encoding: {
          x: {
            field: "d",
            type: "temporal",
            title: "Year",
            axis: { format: "%Y", tickCount: 6, grid: false, labelFlush: true, titlePadding: 20 }
          },
          y: {
            field: "earnings",
            type: "quantitative",
      ...
      },
      {
        ...
        mark: { type: "text", dy: -25, dx: 90, fontSize: 12, fontWeight: "700", color: "#475569", text: "Maximum Pressure Point" },
        encoding: {
          x: { field: "d", type: "temporal" },
          y: { field: "prices", type: "quantitative" }
        }
  ...
  const vis2 = {
    ...
    layer: [
      ...
      },
      {
        ...
        encoding: { x: { value: 200 }, y: { value: -50 }, text: { field: "label" } }
      },
      {
      ...
      },
      {
        ...
        encoding: {
          ...
          y: { field: "v", type: "quantitative", title: "Annual inflation rate (%)", axis: { titlePadding: 20, gridOpacity: 0.1 } },
